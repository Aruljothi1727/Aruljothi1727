    ...
    <div style={{ margin: '10px' }}>
      ...
      <div style={{ margin: '10px', marginBottom: '20px', padding: '10px' }}>
        ...
        <Slider {...settings}>
          ...
          <Button type="primary"  {...activetab === 'Javascript' ? activetab : ''} onClick={() => handletabchange('Javascript')}>Javascript</Button>
      ...
      <div>
        ...
        {activetab === 'Angular' && (
          <Slider {...cardsettings}>
            {angulardata.map((d) => (
              <Card
                cover={<img src={angular} alt='' width={50} height={200}></img>}>
                <div style={{ display: 'flex', flexDirection: 'column'}}>
                  <Link href="https://ant.design" target="_blank"><div style={{ fontSize: '20px', color: 'black' }}>{d.title}</div></Link>
                  <div style={{ fontSize: '18px' }}>{d.name}</div>
                  <div style={{ display: 'flex', flexDirection: 'row', fontWeight: 'bold' }}>{d.textrating}<Rate disabled defaultValue={d.starrating} /></div>
        ...
        {activetab === 'Next Js' && (
          <Slider {...cardsettings}>
            {nextjsdata.map((d) => (
              <Card
                cover={<img src={nextjs} alt='' width={50} height={200}></img>}>
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                  <Link href="https://ant.design" target="_blank"><div style={{ fontSize: '20px', color: 'black' }}>{d.title}</div></Link>
                  <div style={{ fontSize: '18px' }}>{d.name}</div>
                  <div style={{ display: 'flex', flexDirection: 'row', fontWeight: 'bold' }}>{d.textrating}<Rate disabled defaultValue={d.starrating} /></div>
        ...
        {activetab === 'Node.js' && (
          ...
          <Slider {...cardsettings}>
            {nodejsdata.map((d) => (
              <Card
                cover={<img src={nodejs} alt='' width={50} height={200}></img>}>
                <div style={{ display: 'flex', flexDirection: 'column'}}>
                  <Link href="https://ant.design" target="_blank"><div style={{ fontSize: '20px', color: 'black' }}>{d.title}</div></Link>
                  <div style={{ fontSize: '18px' }}>{d.name}</div>
                  <div style={{ display: 'flex', flexDirection: 'row', fontWeight: 'bold' }}>{d.textrating}<Rate disabled defaultValue={d.starrating} /></div>
        ...
        {activetab === 'Javascript' && (
          <Slider {...cardsettings}>
            {jsdata.map((d) => (
              <Card
                cover={<img src={js} alt='' width={50} height={200}></img>}>
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                  <Link href="https://ant.design" target="_blank"><div style={{ fontSize: '19px', color: 'black' }}>{d.title}</div></Link>
                  <div style={{ fontSize: '18px' }}>{d.name}</div>
                  <div style={{ display: 'flex', flexDirection: 'row', fontWeight: 'bold' }}>{d.textrating}<Rate disabled defaultValue={d.starrating} /></div>
                  <div style={{ fontWeight: 'bold', fontSize: '18px' }}>{d.price}</div>
                </div>
